...
[x] cli params when doing one file to specify a pages pattern to first only extract those from the pdf and then send to ocr. use a pattern as can be done in Adobe or other apps, i.e. (1-3 or 5- or 4,5
